...
(function (factory) {
  ...
  $.extend(Plugin.prototype, {
    init: function() {
      var obj = this,
        $e = this.$element,
        $doc = this.doc;
      $e.addClass('jt__tipso_style').removeAttr('title');
    ...
    tooltip: function() {
      if (!this.tipso_bubble) {
        this.tipso_bubble = $('<div class="jt__tipso_bubble"><div class="jt__tipso_title"></div><div class="jt__tipso_content"></div><div class="jt__tipso_arrow"></div></div>');
      }
    ...
    show: function() {
      ...
      if (obj.settings.showArrow === false) {
          tipso_bubble.find(".jt__tipso_arrow").hide();
      }
      else {
          tipso_bubble.find(".jt__tipso_arrow").show();
      }
      if (obj.mode === 'hide') {
        ...
        tipso_bubble.find('.jt__tipso_title').css({
            background: obj.settings.titleBackground,
            color: obj.settings.titleColor
        });
        tipso_bubble.find('.jt__tipso_content').html(obj.content());
        tipso_bubble.find('.jt__tipso_title').html(obj.titleContent());
        reposition(obj);
    ...
    destroy: function() {
      ...
      $e.removeClass('jt__tipso_style').attr('title', this._title);
    },
  ...
  function removeCornerClasses(obj) {
    ...
    obj.find(".jt__tipso_title").removeClass("top_right_corner bottom_right_corner top_left_corner bottom_left_corner");
  }
  function reposition(thisthat) {
    ...
    switch (obj.settings.position)
    {
      case 'top-right':
        ...
        tipso_bubble.find('.jt__tipso_arrow').css({
        ...
        if (pos_top < $win.scrollTop())
        {
          ...
          tipso_bubble.find(".jt__tipso_title").addClass("bottom_right_corner");
          tipso_bubble.find('.jt__tipso_arrow').css({
      ...
      case 'top-left':
        ...
        if (pos_top < $win.scrollTop())
        {
          ...
          tipso_bubble.find(".jt__tipso_title").addClass("bottom_left_corner");
          tipso_bubble.find('.jt__tipso_arrow').css({
      ...
      case 'bottom-right':
       ...
       if (pos_top + realHeight(tipso_bubble).height > $win.scrollTop() + $win.outerHeight())
       {
         ...
         removeCornerClasses(tipso_bubble);
         tipso_bubble.addClass("top_right_corner");
         tipso_bubble.find(".jt__tipso_title").addClass("top_left_corner");
         tipso_bubble.find('.jt__tipso_arrow').css({
           'border-left-color': obj.settings.background,
         });
         tipso_bubble.removeClass('top-right top bottom left right');
    ...
    {
      var tipso_arrow = tipso_bubble.find(".jt__tipso_arrow").eq(0);
      tipso_arrow.css({
